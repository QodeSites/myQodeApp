...
export default function FamilyPortfolioSection() {
  ...
  return (
    <Container className="p-4 w-full flex rounded-lg bg-card">
      ...
      <View className="text-sm font-sans text-muted-foreground mt-2">
        {isHeadOfFamily ? (
      ...
      {sortedGroupEntries.length === 0 ? (
        ...
        <View className="border border-primary rounded-lg p-2">
          {sortedGroupEntries.map(([groupKey, group]) => {
            ...
            return (
              <View key={groupKey} className="bg-card rounded-xl overflow-hidden py-0 p-0 md:p-6 mb-2">
                <View className="p-2 md:p-6">
                  <TouchableOpacity
                    className="flex flex-row items-center gap-3 mb-4 cursor-pointer hover:bg-muted/50 rounded p-2 -m-2"
                                      ...
                                      return (
                                        <View key={`${account.clientid}-${accountIdx}`} className="relative mb-3">
                                          ...
                                          <View className="ml-2 md:ml-4">
                                            ...
                                            {!isAccountCollapsed && (
                                              <View className="ml-2 md:ml-4 p-3 bg-muted/20 rounded-lg border-l-2 border-primary/10">
